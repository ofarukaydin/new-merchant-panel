export const endpoints = {
  ...
  auth: {
    ...
    validateForgetPasswordRequest: 'Authentication/validateforgetpasswordrequest',
  ...
  catalog: {
    ...
    GetSubCategoriesWithProductsAsync: 'Product/getsubcategorieswithproductsasync',
    SearchProductAsync: 'Product/searchproductasync',
    GetSubCategoriesWithProductsByCategory: 'Product/getsubcategorieswithproductsbycategoryid',
    GetBaseCategoriesByLatLong: 'Product/getbasecategoriesbylatlong',
    GetSubCategoriesByLatLongCategoryId: 'Product/getsubcategorieswithproductsbylatlongcategoryid',
